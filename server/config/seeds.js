  ...
  const products = await Product.insertMany([
    {
      name: "Cargo Van",
      description:
        "Perfect for small jobs around town. Out cargo vans feature nerf bars to help you step into the van easier. Examples of how it can be used: twin-sized mattress, spring box, three-seater sofa and two nightstands. The price of the cargo van is based on a day use and doesn't include other fees for use.",
